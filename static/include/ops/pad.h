...
void InvokePad(
  ...
  if (rank == 1) {
    ...
    if (strcmp(mode, "constant") == 0) {
      ait::pad_kernel_constant_1d<<<num_blocks, threads_per_block, 0, stream>>>(
      ...
      ait::pad_kernel_reflect_1d<<<num_blocks, threads_per_block, 0, stream>>>(
          static_cast<const ElemInputType*>(in_ptr),
          static_cast<ElemOutputType*>(out_ptr),
          N,
          pad_left,
      ...
      ait::pad_kernel_circular_1d<<<num_blocks, threads_per_block, 0, stream>>>(
          static_cast<const ElemInputType*>(in_ptr),
          static_cast<ElemOutputType*>(out_ptr),
          N,
          pad_left,
    ...
    num_blocks = (total_elements + threads_per_block - 1) / threads_per_block;
    if (strcmp(mode, "constant") == 0) {
      ait::pad_kernel_constant_2d<<<num_blocks, threads_per_block, 0, stream>>>(
          static_cast<const ElemInputType*>(in_ptr),
          static_cast<ElemOutputType*>(out_ptr),
          N,
          H,
      ...
      ait::pad_kernel_reflect_2d<<<num_blocks, threads_per_block, 0, stream>>>(
          static_cast<const ElemInputType*>(in_ptr),
          static_cast<ElemOutputType*>(out_ptr),
          N,
          H,
      ...
      ait::pad_kernel_circular_2d<<<num_blocks, threads_per_block, 0, stream>>>(
          static_cast<const ElemInputType*>(in_ptr),
          static_cast<ElemOutputType*>(out_ptr),
          N,
          H,
    ...
    num_blocks = (total_elements + threads_per_block - 1) / threads_per_block;
    if (strcmp(mode, "constant") == 0) {
      ait::pad_kernel_constant_3d<<<num_blocks, threads_per_block, 0, stream>>>(
          static_cast<const ElemInputType*>(in_ptr),
          static_cast<ElemOutputType*>(out_ptr),
          N,
          H,
      ...
      ait::pad_kernel_reflect_3d<<<num_blocks, threads_per_block, 0, stream>>>(
          static_cast<const ElemInputType*>(in_ptr),
          static_cast<ElemOutputType*>(out_ptr),
          N,
          H,
      ...
      ait::pad_kernel_circular_3d<<<num_blocks, threads_per_block, 0, stream>>>(
          static_cast<const ElemInputType*>(in_ptr),
          static_cast<ElemOutputType*>(out_ptr),
          N,
          H,
    ...
    num_blocks = (total_elements + threads_per_block - 1) / threads_per_block;
    if (strcmp(mode, "constant") == 0) {
      ait::pad_kernel_constant_4d_nhwc<<<
          num_blocks,
          threads_per_block,
          0,
          stream>>>(
      ...
      ait::pad_kernel_reflect_4d_nhwc<<<
          num_blocks,
          threads_per_block,
          0,
          stream>>>(
      ...
      ait::pad_kernel_replicate_4d_nhwc<<<
          num_blocks,
          threads_per_block,
          0,
          stream>>>(
      ...
      ait::pad_kernel_circular_4d_nhwc<<<
          num_blocks,
          threads_per_block,
          0,
          stream>>>(
