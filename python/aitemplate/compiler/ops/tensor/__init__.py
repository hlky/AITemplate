...
reduce module init
"""
from aitemplate.compiler.ops.tensor.arange import arange
...
from aitemplate.compiler.ops.tensor.meshgrid import meshgrid
from aitemplate.compiler.ops.tensor.pad import pad
