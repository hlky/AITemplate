        ...
        for pad_mode in ["constant"]:
            for pad in [(1, 1), (0, 1), (1, 0)]:
                self._test_single_op(
                    ...
                    value=1.0,
                    input_shape=[10],
                    test_name=f"pad_{pad_mode}_1d_{ait_dtype}_{'-'.join([str(n) for n in pad])}",
                    dtype=ait_dtype,
                )
        for pad_mode in pad_modes:
            for pad in [(1, 1), (0, 1), (1, 0)]:
                self._test_single_op(
                    ...
                    value=1.0,
                    input_shape=[3, 4],
                    test_name=f"pad_{pad_mode}_2d_{ait_dtype}_{'-'.join([str(n) for n in pad])}",
                    dtype=ait_dtype,
                )
        for pad_mode in pad_modes:
            for pad in [(1, 1, 2, 2), (0, 1, 0, 1), (0, 1, 0, 0)]:
                self._test_single_op(
                    ...
                    value=1.0,
                    input_shape=[2, 3, 4],
                    test_name=f"pad_{pad_mode}_3d_{ait_dtype}_{'-'.join([str(n) for n in pad])}",
                    dtype=ait_dtype,
                )
        for pad_mode in pad_modes:
            for pad in [(1, 1, 2, 2), (0, 1, 0, 1), (0, 1, 0, 0)]:
                self._test_single_op(
                    ...
                    value=1.0,
                    input_shape=[1, 3, 3, 3],
                    test_name=f"pad_{pad_mode}_4d_{ait_dtype}_{'-'.join([str(n) for n in pad])}",
                    dtype=ait_dtype,
                )
